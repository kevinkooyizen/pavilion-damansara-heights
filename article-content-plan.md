...
3. **Key Klang Valley areas** — Mont Kiara, KLCC, Bangsar, Damansara Heights, PJ, Subang (brief; link to C2 and C5)
...
7. **Top condo developments to consider** — e.g. 10 Mont Kiara, Kiaraville, Sunway Vivaldi (non-promotional tone)
...
3. **Best areas for rental yield**
   ...
   - KLCC/Bukit Bintang: 4%–5% (business travellers, professionals)
...
| 3 | Pillar | Publish after C1 and C2 exist so internal links are live |
| 4 | C3 — MM2H | Long-tail, high-conversion — worth early investment |
| 5 | C5 — Family Areas | Builds on C2; targets wider family audience |
| 6 | C4 — Buy vs Rent | Corporate expat angle; strong for LinkedIn distribution |
| 7 | C6 — Investment | Most complex; best written once team is confident in the niche |
